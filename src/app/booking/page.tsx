...
import StoreTiga from "@/assets/images/thumbnails/store-3.png";
import TickCircle from "@/assets/images/icons/tick-circle.svg";
import StoreDua from "@/assets/images/thumbnails/store-2.png";
import StoreSatu from "@/assets/images/thumbnails/store-1.png";
import Car from "@/assets/images/icons/car.svg";
import BuildingEmpat from "@/assets/images/icons/building-4.svg";
          ...
          <form action="payment.html" className="flex flex-col gap-4 mt-5 z-10">
            <div className="flex flex-col py-5 px-4 gap-4 bg-[#F9FAFB]">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 flex shrink-0">
                      <Image src={BuildingEmpat} alt="icon" />
                    </div>
                    <p>Pickup Store</p>
                  </div>
                  <input
              ...
              <div className="tabs-contents">
                ...
                <div
                  id="delivery-tab"
                  className="tabcontent flex flex-col hidden"
                >
                  <div className="flex flex-col gap-1">
                    <p className="font-semibold text-sm leading-[21px]">
                      Alamat Rumah
                    </p>
                    <p className="text-xs leading-[22px] text-[#6E6E70]">
                      Sebagai contoh Perumahan Citra Lestari No 12, Blok B 11/7,
                      Jawa Barat, Bogor, 40556
                    </p>
                  </div>
                  <textarea
                    name="address"
