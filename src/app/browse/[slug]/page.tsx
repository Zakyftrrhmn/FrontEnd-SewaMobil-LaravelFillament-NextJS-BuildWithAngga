...
import AvatarSatu from "@/assets/images/avatars/avatar-1.png";
import AvatarDua from "@/assets/images/avatars/avatar-2.png";
import GalerySatu from "@/assets/images/photos/gallery-1.png";
import GaleryDua from "@/assets/images/photos/gallery-2.png";
import GaleryTiga from "@/assets/images/photos/gallery-3.png";
import GaleryEmpat from "@/assets/images/photos/gallery-4.png";
...
export default function BrowseDetailPage() {
  ...
  return (
    <div>
      <div
        id="Top-Bar"
        className="flex items-center justify-between px-4 mt-[60px] z-10 cursor-pointer"
      >
        <Image
          src={BackBorder}
          ...
          <div className="swiper-gallery w-full overflow-hidden">
            <div className="swiper-wrapper">
              <div className="swiper-slide !w-fit">
                <button className="flex m-3 w-[130px] h-[100px] shrink-0 rounded-[20px] overflow-hidden bg-[#1D68B4]">
                  <Image
                    src={GalerySatu}
